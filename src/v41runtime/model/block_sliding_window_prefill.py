...
from v41runtime.model.attention_sliding_window import (
...
def sliding_window_block_prefill(
    layer_id: int,
    x: mx.array,
    *,
    start_pos: int,
    ...
    """
    Layer-major prompt prefill for a pure sliding-window layer.
    ...
    Attention is replayed sequentially across prompt positions to
    preserve exact causal/ring-cache semantics.

    HC operations are batched and routed MoE work is scheduled
    expert-major.
    """
    if x.ndim != 3:
        raise ValueError(
