...
from v41runtime.model.attention_sliding_window import sliding_window_attention_decode
...
def sliding_window_block_decode(
    layer_id: int,
    x: mx.array,
    *,
    start_pos: int,
    ...
    """
    Complete DeepSeek V4.1 Flash pure sliding-window backbone block for one decode token.
